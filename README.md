...
oversampling strategy and the use of Focal Loss, with only `30` percentage of the data used for training.

The Demo is Available on [Huggingface](https://huggingface.co/spaces/Factor054/Salads_Classifier_Demo).
